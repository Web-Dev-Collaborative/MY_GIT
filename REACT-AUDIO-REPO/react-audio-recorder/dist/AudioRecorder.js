...
var AudioRecorder = /** @class */ (function (_super) {
    ...
    AudioRecorder.prototype.render = function () {
        return (React.createElement("div", { className: "AudioRecorder" },
            ...
            this.state.audioData && (React.createElement("button", { className: "AudioRecorder-remove", onClick: this.onRemoveClick }, this.props.removeLabel)),
            this.state.audioData && this.props.downloadable && (React.createElement("button", { className: "AudioRecorder-download", onClick: this.onDownloadClick }, this.props.downloadLabel))));
    };
